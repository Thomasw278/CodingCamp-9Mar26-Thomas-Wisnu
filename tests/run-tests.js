/**
 * Node.js Test Runner - Runs all component tests
 * Executes StorageManager, GreetingComponent, and TimerComponent tests
 */
...
console.log('='.repeat(70));
try {
  execSync('node tests/storage-manager.test.js', { stdio: 'inherit' });
} catch (error) {
  allPassed = false;
}

// Run GreetingComponent tests
console.log('\n👋 GREETING COMPONENT TESTS');
console.log('='.repeat(70));
try {
  execSync('node tests/greeting-component.test.js', { stdio: 'inherit' });
} catch (error) {
  allPassed = false;
}

// Run TimerComponent tests
console.log('\n⏱️  TIMER COMPONENT TESTS');
console.log('='.repeat(70));
try {
  execSync('node tests/timer-component.test.js', { stdio: 'inherit' });
} catch (error) {
  allPassed = false;
}
...
console.log('='.repeat(70));
try {
  execSync('node tests/task-validation.test.js', { stdio: 'inherit' });
} catch (error) {
  allPassed = false;
}

// Run TaskListComponent tests
console.log('\n📝 TASK LIST COMPONENT TESTS');
console.log('='.repeat(70));
try {
  execSync('node tests/task-list-component.test.js', { stdio: 'inherit' });
} catch (error) {
  allPassed = false;
}

// Run QuickLinksComponent tests
console.log('\n🔗 QUICK LINKS COMPONENT TESTS');
console.log('='.repeat(70));
try {
  execSync('node tests/quick-links-component.test.js', { stdio: 'inherit' });
} catch (error) {
  allPassed = false;
}

// Run ThemeComponent tests
console.log('\n🎨 THEME COMPONENT TESTS');
console.log('='.repeat(70));
try {
  execSync('node tests/theme-component.test.js', { stdio: 'inherit' });
} catch (error) {
  allPassed = false;
}
...
console.log('='.repeat(70));
try {
  execSync('node tests/performance.test.js', { stdio: 'inherit' });
} catch (error) {
  allPassed = false;
}
...
/**
 * Original StorageManager Test Runner
 * Kept below for reference/standalone execution
 */
